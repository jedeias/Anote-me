...
CREATE DATABASE IF NOT EXISTS `clinica_psicologica` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE IF NOT EXISTS `anotacoes_paciente` (
  ...
  `fk_anotacoes_psicologo` int(11) DEFAULT NULL,
  `anotacoes` text,
...
REPLACE INTO `anotacoes_paciente` (`pk_anotacoes_paciente`, `fk_redflag`, `fk_emocoes`, `fk_paciente`, `fk_anotacoes_psicologo`, `anotacoes`, `data_hora`) VALUES
	(29, 1, 1, 2, 11, 'Estou me sentindo muito ansioso', '2022-05-10 11:30:00'),
	(30, 2, 2, 3, 12, 'Estou me sentindo triste e sem autoestima', '2022-05-12 12:30:00');
...
REPLACE INTO `anotacoes_psicologo` (`pk_anotacoes_psicologo`, `fk_psicologo`, `fk_consulta`, `data_hora`, `anotacoes`) VALUES
...
-- Copiando estrutura para tabela clinica_psicologica.atividade
...
-- Copiando dados para a tabela clinica_psicologica.atividade: ~5 rows (aproximadamente)
...
-- Copiando estrutura para tabela clinica_psicologica.emocoes
...
-- Copiando dados para a tabela clinica_psicologica.emocoes: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `emocoes` DISABLE KEYS */;
REPLACE INTO `emocoes` (`pk_emocoes`, `local_img`, `descricao`, `emoji`) VALUES
	(1, '', 'triste', 'foto_triste'),
	(2, '', 'feliz', 'foto_triste'),
	(3, '', 'indiferente', 'foto_triste'),
	(4, '', 'euforico', 'foto_triste'),
	(5, '', 'ancioso', 'foto_triste');
...
-- Copiando dados para a tabela clinica_psicologica.paciente: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `paciente` DISABLE KEYS */;
REPLACE INTO `paciente` (`pk_paciente`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `fk_responsavel`, `nome`, `email`, `senha`, `RG`, `CPF`, `sexo`, `data_nasc`, `fk_atividade`) VALUES
	(2, 1, 2, 3, 1, 'Joãozinho da Silva', 'joaozinho@example.com', 'senha123', '111111111', 1234567890, 'M', '2010-01-01', NULL),
	(3, 2, 1, 3, 2, 'Mariazinha Pereira', 'mariazinha@example.com', 'senha123', '222222222', 1098765432, 'F', '2012-01-01', 2);
...
REPLACE INTO `responsavel` (`pk_responsavel`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `nome`, `email`, `RG`, `CPF`) VALUES
	(1, 1, 1, 1, 'Fulano de Tal', 'fulano@example.com', '123456789', '12345678901'),
	(2, 2, 2, 1, 'Ciclano de Tal', 'ciclano@example.com', '987654321', '10987654321');
...
-- Copiando dados para a tabela clinica_psicologica.secretario: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela clinica_psicologica.secretario_clinica: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela clinica_psicologica.tipo_atividade
...
-- Copiando dados para a tabela clinica_psicologica.tipo_atividade: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela clinica_psicologica.tipo_usuario: ~8 rows (aproximadamente)
