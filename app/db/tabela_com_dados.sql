...
REPLACE INTO `paciente` (`pk_paciente`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `fk_responsavel`, `nome`, `email`, `senha`, `RG`, `CPF`, `sexo`, `data_nasc`, `fk_atividade`) VALUES
	(2, 1, 2, 3, 1, 'Joãozinho da Silva', 'joaozinho@example.com', 'senha123', '111111111', 123456789, 'M', '2010-01-01', 5),
	(3, 2, 1, 3, 2, 'Mariazinha Pereira', 'mariazinha@example.com', 'senha123', '222222222', 109876543, 'F', '2012-01-01', 2),
	(4, 3, 4, 3, 1, 'Pedrinho Souza', 'pedrinho@example.com', 'senha123', '333333333', 246801357, 'M', '2014-01-01', 1),
	(5, 4, 3, 3, 2, 'Lucinha Carvalho', 'lucinha@example.com', 'senha123', '444444444', 135790246, 'F', '2016-01-01', 3),
	(6, 5, 5, 3, 2, 'Carlos Eduardo', 'carlos@example.com', 'senha123', '555555555', 864209753, 'M', '2018-01-01', 4);
