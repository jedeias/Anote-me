...
CREATE TABLE IF NOT EXISTS `anotacoes_paciente` (
  ...
  KEY `anotacoes_paciente_ibfk_5` (`fk_psicologo`),
...
INSERT INTO `anotacoes_paciente` (`pk_anotacoes_paciente`, `fk_redflag`, `fk_emocoes`, `fk_paciente`, `fk_psicologo`, `fk_anotacoes_psicologo`, `anotacoes`, `data`, `hora`) VALUES
...
-- Copiando dados para a tabela clinica_psicologica.anotacoes_psicologo: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela clinica_psicologica.consulta: ~0 rows (aproximadamente)
...
DELETE FROM `emocoes`;
INSERT INTO `emocoes` (`pk_emocoes`, `local_img`, `descricao`, `emoji`, `intensidade`) VALUES
...
INSERT INTO `paciente` (`pk_paciente`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `fk_responsavel`, `fk_psicologo`, `fk_atividade`, `nome`, `email`, `senha`, `RG`, `CPF`, `sexo`, `data_nasc`) VALUES
	(2, 1, 2, 3, 1, 11, 5, 'Joãozinho da Silva', 'joaozinho@example.com', 'senha123', '111111111', 123456789, 'M', '2010-01-01'),
	(3, 2, 1, 3, 2, 11, 2, 'Mariazinha Pereira', 'mariazinha@example.com', 'senha123', '222222222', 109876543, 'F', '2012-01-01'),
	(4, 3, 4, 3, 1, 12, 1, 'Pedrinho Souza', 'pedrinho@example.com', 'senha123', '333333333', 246801357, 'M', '2014-01-01'),
	(5, 4, 3, 3, 2, 13, 3, 'Lucinha Carvalho', 'lucinha@example.com', 'senha123', '444444444', 135790246, 'F', '2016-01-01'),
	(6, 5, 5, 3, 2, 12, 4, 'Carlos Eduardo', 'carlos@example.com', 'senha123', '555555555', 864209753, 'M', '2018-01-01');
...
INSERT INTO `psicologo` (`pk_psicologo`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `nome`, `email`, `senha`, `RG`, `CPF`, `sexo`, `data_nasc`) VALUES
...
-- Copiando dados para a tabela clinica_psicologica.red_flag: ~0 rows (aproximadamente)
...
INSERT INTO `secretario` (`pk_secretario`, `fk_endereco`, `fk_telefone`, `fk_tipo_usuario`, `nome`, `email`, `senha`, `RG`, `CPF`, `sexo`, `data_nasc`) VALUES
